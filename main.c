...
int main(void)
{
  ...
  // Iniciar la recepción de UART1 con interrupciones
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart) {
    if (huart->Instance == USART1) {
        // Convertimos el carácter ASCII recibido a su valor numérico
        ...
        // Reiniciar la recepción para el siguiente byte
        HAL_UART_Receive_IT(&huart1, &received_designator, 1);
    }
}
